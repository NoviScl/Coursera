...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        threads = [(i, thread_embeddings[i], scores[i]) for i in range(thread_embeddings.shape[0])]
        sort_threads = sorted(threads, key=lambda x: x[2], reverse=True)
        best_thread = sort_threads[0][0]
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #later try other models for chit chat
